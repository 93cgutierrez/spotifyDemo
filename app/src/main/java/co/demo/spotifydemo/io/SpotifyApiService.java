...
public interface SpotifyApiService {
    ...
    @GET("search?type=type=artist&locale=es-CO%2Ces-US%3Bq%3D0.9%2Ces-419%3Bq%3D0.8%2Ces%3Bq%3D0.7&offset=0&limit=20")
    Observable<Response<QueryResponse>> searchArtists(@Query("query") String query);

    @GET("artists/{artistId}/albums?offset=2&limit=1&include_groups=album,single,compilation,appears_on&locale=es-CO,es-US;q=0.9,es-419;q=0.8,es;q=0.7")
